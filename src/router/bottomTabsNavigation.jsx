...
import {Home,HomeField,Search,SearchField,Reel,ReelField,Shop,ShopField} from "../utils/Icons"
import { Image, StyleSheet } from 'react-native';

const TabNavigation = createBottomTabNavigator();
//! obje dağıtma
const {HOMESCREEN,PROFILESCREEN,SEARCHSCREEN,REELSCREEN,SHOPSCREEN} =SCREENS
  ...
  return (
    <TabNavigation.Navigator screenOptions={{
      ...
      headerShown: false
        ...
        name={REELSCREEN} component={ReelScreen} />
        <TabNavigation.Screen 
         options={{
          tabBarIcon: ({ focused }) => 
